...
public class GoodsDetailsBean {
    ...
    private  PropertiesBean  propertiesBeen;
    ...
    public PropertiesBean getPropertiesBeen() {
        return propertiesBeen;
    }

    public void setPropertiesBeen(PropertiesBean propertiesBeen) {
        this.propertiesBeen = propertiesBeen;
    }
